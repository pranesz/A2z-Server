...
//     await hotel.save();
//     res.status(201).json({ message: "Hotel posted successfully",hotel: hotel });
//   } catch (error) {
...
//     const hotels = await Hotel.find({ userId }); // Fetch hotels for the user
//     res.status(200).json(hotels);
//   } catch (error) {
//     console.error("Error fetching user hotels:", error);
//     res.status(500).json({ message: "Failed to fetch user hotels" });
//   }
// };
